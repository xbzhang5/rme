...
Dobson, Annette J., and Adrian G. Barnett. An introduction to
generalized linear models. 3<sup>rd</sup> edition. CRC press, 2008
(mostly chapters 3-5).

I’ve added this book to the "Reading List" on canvas, so it should be
uploaded there by the librarians soon.

Some material was also taken from:

McLachlan, Geoffrey J., and Thriyambakam Krishnan. The EM algorithm and
...
Australia ; Pacific Grove, CA, Thomson Learning.
