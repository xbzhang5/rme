...
$$\omega(\pi) \eqdef \frac{\pi}{1-\pi}$${#eq-odds-probs}

[Function #eq-odds-probs], which transforms probabilities into odds, is called the **odds function**. @fig-odds-probs graphs the shape of this function.
