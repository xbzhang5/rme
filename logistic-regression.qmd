...
Logistic regression is a method for estimating and predicting the risk of a *binary outcome variable* using one or more predictors. 

:::{#def-binary}

### binary variable
A **binary variable** is a random variable which has only two possible values (such as diseased/healthy).
:::
