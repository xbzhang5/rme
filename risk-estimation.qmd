...
Logistic regression is a method for estimating and predicting the probability of a **binary outcome** using one or more predictors. 

:::{#def-binary}

# binary variable
A random variable which has only two possible values (such as diseased/healthy) in its range.
:::
