...
$$p(y|A,x_2) \iid N(\mu(A,x_2), \sigma^2)$$

$$
\ba
\mu(A,x_2)
&\eqdef \Exp{Y|A=a, S=x_2} \\
&= \beta_0 + \beta_a a+ \beta_2 x_2
\ea
$$ {#eq-lm-parallel}
...
$$
E[Y|A, S] = \beta_0 + \beta_1 A+ \beta_2 S + \beta_3 (A \cdot S)
$$
...
$$
E[Y|A, S] = \beta_0 + \beta_1 A+ (\beta_2 + \beta_3 A) S
$$
...
$$E[Y|A = 0, X_2 = 36] = \beta_0 + \beta_1 \cdot 0+ \beta_2 \cdot 36 + \beta_3 \cdot (0 * 36) =  `r pred_female`$$ What's the mean birthweight for a male born at 36 weeks?
...
$$E[Y|A = 0, X_2 = 36] = \beta_0 + \beta_1 \cdot 1+ \beta_2 \cdot 36 + \beta_3 \cdot 1 \cdot 36 =  `r pred_male`$$
