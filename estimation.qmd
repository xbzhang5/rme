...
## Estimands, estimates, and estimators {.scrollable}
...
## Accuracy of estimators {#sec-est-accuracy .scrollable}
...
Essentially, standard error is what is left of MSE after bias is removed. For unbiased estimators, SE = RMSE (this is an equivalent result to @eq-unbiased-mse).
