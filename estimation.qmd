...
$\mselr{\hth}$ and $\sqf{\bias{\hth}} + \var{\hth}$ both equal $\E{\hth^2} - 2\E{\hth}\th+\th^2$, so by the transitivity property of equality, $\mselr{\hth}$ and $\sqf{\bias{\hth}} + \var{\hth}$ are equal:
